...
export default class Blog extends Component {
    ...
    tlalpan = "Sucursal Coapa";
    mixcoac = "Sucursal Mixcoac";
    tepalcates = "Sucursal Iztapalapa";
        ...
        return (
            ...
            <footer className="site-footer" id='ubicaciones'>
                <div className="site-footer__upper">
                    ...
                    <h3 className='suc'>Una clínica para eliminar piojos 
                    <b>cerca de ti</b></h3>
                        <div className="row">
                            ...
                            <div className="col-lg-9 d-flex justify-content-around footer-widget__links-wrap">
                                <div className="footer-widget sucursal">
                                    ...
                                    <ul className="footer-widget__links list-unstyled">
                                        ...
                                        <a href="https://wa.me/525570127591?text=Hola%20Sin%20Piojos%C2%AE.%20Coapa%20Me%20puedes%20dar%20info%20sobre%20los%20tratamientos%20para%20eliminar%20piojos?%20Gracias."  className='btn-ubi btn-align no-style'><IoLogoWhatsapp />Agenda por WhatsApp</a>
                                    </ul>
                                </div>
                                <div className="footer-widget sucursal">
                            ...
                            <div className="col-lg-1">
                                <div className="footer-widget footer-widget__about">
                                    <img src="/assets/images/resources/logo-dark.webp" width="119" alt=""
